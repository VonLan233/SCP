...
class LinearRegressionPredictor:
    ...
    def __init__(self, model_path="predictor/models", confidence_level=0.95,timeSteps=5,predictionSteps=1):
        """
        初始化线性回归预测器
        ...
        logger.info(f"初始化线性回归预测器: confidence_level={confidence_level}")

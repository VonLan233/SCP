...
class GRUModel:
    ...
    def build_advanced_model(self):
        """
        构建高级GRU模型，包含双向GRU和Batch Normalization
        ...
        # 双向GRU增强特征提取能力
        x = Bidirectional(GRU(units=self.units, 
                             return_sequences=True,
        ...
        # 第二层GRU
        x = Bidirectional(GRU(units=self.units//2, 

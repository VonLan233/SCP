...
const ModelSettings: React.FC<ModelSettingsProps> = ({
  ...
  setSettings({
    ...settings,
    [field]: field === "modelType" ? value : parseFloat(value)
  });
};
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange("timeSteps", e.target.value)}
              />
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange("predictionSteps", e.target.value)}
              />
            ...
            {/* <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange("force_retrain", e.target.checked)}
              />
